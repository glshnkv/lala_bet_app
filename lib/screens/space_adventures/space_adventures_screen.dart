...
@RoutePage()
class SpaceAdventuresScreen extends StatefulWidget {
  const SpaceAdventuresScreen({super.key});

  @override
  State<SpaceAdventuresScreen> createState() => _SpaceAdventuresScreenState();
}

class _SpaceAdventuresScreenState extends State<SpaceAdventuresScreen> {
  ...
  List<String> elements = [
    'assets/images/space-adventures/1.png',
    'assets/images/space-adventures/2.png',
    'assets/images/space-adventures/3.png',
    'assets/images/space-adventures/4.png',
  ];
    ...
    for (int i = 0; i < 6; i++) {
      for (int j = 0; j < 3; j++) {
        if (board[i][j] == board[i][j + 1] && board[i][j] == board[i][j + 2]) {
          switch (board[i][j]) {
            case 'assets/images/space-adventures/1.png':
              if (firstItem < 7) {
                firstItem += 1;
                if (firstItem == 7) {
                  arrows += 1;
            ...
            case 'assets/images/space-adventures/2.png':
              if (secondItem < 7) {
                secondItem += 1;
                if (secondItem == 7) {
                  arrows += 1;
            ...
            case 'assets/images/space-adventures/3.png':
              if (thirdItem < 7) {
                thirdItem += 1;
                if (thirdItem == 7) {
                  arrows += 1;
            ...
            case 'assets/images/space-adventures/4.png':
              if (fourthItem < 7) {
                fourthItem += 1;
                if (fourthItem == 7) {
                  arrows += 1;
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage("assets/images/space-adventures/bg.png"),
              fit: BoxFit.cover,
            ),
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Stack(
                    ...
                    children: [
                      Image.asset('assets/images/space-adventures/avatar.png'),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Column(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Stack(
                          ...
                          children: [
                            Image.asset(
                                'assets/images/space-adventures/bottom.png'),
                            Text(
                      ...
                      SizedBox(
                        ...
                        child: Stack(
                          ...
                          children: [
                            Image.asset(
                                'assets/images/space-adventures/board.png'),
                            Center(
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
