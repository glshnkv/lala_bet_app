...
@RoutePage()
class MysteriousFishingScreen extends StatefulWidget {
  const MysteriousFishingScreen({super.key});

  @override
  State<MysteriousFishingScreen> createState() => _MysteriousFishingScreenState();
}


class _MysteriousFishingScreenState extends State<MysteriousFishingScreen> {
  ...
  List<String> elements = [
    'assets/images/mysterious-fishing/1.png',
    'assets/images/mysterious-fishing/2.png',
    'assets/images/mysterious-fishing/3.png',
    'assets/images/mysterious-fishing/4.png',
  ];
    ...
    for (int i = 0; i < 6; i++) {
      for (int j = 0; j < 3; j++) {
        if (board[i][j] == board[i][j + 1] && board[i][j] == board[i][j + 2]) {
          switch (board[i][j]) {
            case 'assets/images/mysterious-fishing/1.png':
              if (firstItem < 10) {
                firstItem += 1;
                if (firstItem == 10) {
                  arrows += 1;
            ...
            case 'assets/images/mysterious-fishing/2.png':
              if (secondItem < 10) {
                secondItem += 1;
                if (secondItem == 10) {
                  arrows += 1;
            ...
            case 'assets/images/mysterious-fishing/3.png':
              if (thirdItem < 10) {
                thirdItem += 1;
                if (thirdItem == 10) {
                  arrows += 1;
            ...
            case 'assets/images/mysterious-fishing/4.png':
              if (fourthItem < 10) {
                fourthItem += 1;
                if (fourthItem == 10) {
                  arrows += 1;
  ...
  int endTime() {
    final int levelCountdownTimer = 4 * 60 * 1000 + 0 * 1000;
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage("assets/images/mysterious-fishing/bg.png"),
              fit: BoxFit.cover,
            ),
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Stack(
                    ...
                    children: [
                      Image.asset('assets/images/mysterious-fishing/avatar.png'),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Column(
                            children: [
                              ItemCounterWidget(
                                itemPath: 'assets/images/mysterious-fishing/1.png',
                                counter: '$firstItem / 10',
                                color: Color(0xFF4CA319),
                              ),
                              SizedBox(height: 10),
                              ItemCounterWidget(
                                itemPath: 'assets/images/mysterious-fishing/2.png',
                                counter: '$secondItem / 10',
                                color: Color(0xFF4CA319),
                              ),
                            ],
                          ),
                          Column(
                            children: [
                              ItemCounterWidget(
                                itemPath: 'assets/images/mysterious-fishing/3.png',
                                counter: '$thirdItem / 10',
                                color: Color(0xFF4CA319),
                              ),
                              SizedBox(height: 10),
                              ItemCounterWidget(
                                itemPath: 'assets/images/mysterious-fishing/4.png',
                                counter: '$fourthItem / 10',
                                color: Color(0xFF4CA319),
                              ),
                            ],
                          ),
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Stack(
                          ...
                          children: [
                            Image.asset(
                                'assets/images/mysterious-fishing/bottom.png'),
                            Text(
                      ...
                      SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.center,
                          children: [
                            Image.asset('assets/images/mysterious-fishing/board.png'),
                            Center(
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
